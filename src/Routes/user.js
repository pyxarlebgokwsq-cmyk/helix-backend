  ...
  const sdk = {
    "client": {
      ...
      "LobbyClient": {
        ...
        "LobbySocketURL": "ws://api.epicgames.dev/lobby/v1/`deploymentId/lobbies/connect",
      ...
      "Messaging.Stomp": {
        ...
        "Url": "ws://api.epicgames.dev/notifications/v1/`deploymentid`/connect",
      ...
      "AntiCheat.GameplayData": {
        "Url": "ws://api.epicgames.dev/cerberus-edge/v1/"
      },
      "AuthClient": {
